!function(o) {
    ...
    var e = {
        ...
        modal: function() {
            ...
            e.modal_prevnext(s, t),
            a.on("click", function() {
                return t.removeClass("opened hovered"),
        ...
        modal_prevnext: function(e, t) {
            ...
            e.find("a").off().on("click", function() {
                ...
                o(".resumo_fn_modalbox .modal_content").stop().animate({
                    scrollTop: 0
                }, 500, "swing"),
        ...
        changeWidth: function() {
            var t = o(window).scrollTop()
              , n = 0;
            t > 0 && !o("body").hasClass("scrolled") ? (o("body").addClass("scrolled"),
            n++) : 0 === t && o("body").hasClass("scrolled") && (o("body").removeClass("scrolled"),
            n++),
        ...
        contactForm: function() {
            o("send_message").on("click", function() {
                var e = o(".resumo_fn_contact .contact_form")
                  ...
                  , l = e.data("email");
                return r.empty(),
                "" === t || "" === n || "" === a || "" === l || "" === s ? o(".empty_notice").slideDown(500).delay(2e3).slideUp(500) : o.post("modal/contact.php", {
                    ajax_name: t,
                    ajax_email: n,
                    ajax_emailto: l,
                    ajax_message: a,
                    ...
                    r.append(o),
                    r.find(".contact_error").length ? r.slideDown(500).delay(2e3).slideUp(500) : (r.append("<span class='contact_success'>" + i + "</span>"),
        ...
        loadBlogPosts: function() {
            o(".resumo_fn_blog_list .load_more a").on("mousedown", function() {
                var e = o(this)
                  , t = e.find(".text");
                if (e.hasClass("done"))
                    return e.addClass("hold"),
                    t.text(e.attr("data-no")),
                    !1
            }).on("mouseup", function() {
                var e = o(this)
                  , t = e.find(".text");
                if (e.hasClass("done"))
                    return e.removeClass("hold"),
            ...
            o(".resumo_fn_blog_list .load_more a").on("click", function() {
                var e = o(this)
                  , t = e.find(".text");
                return !e.hasClass("loading") && !e.hasClass("done") && (e.addClass("loading"),
                setTimeout(function() {
        ...
        testimonialCarousel: function() {
            o(".resumo_fn_testimonials .owl-carousel").each(function() {
                ...
                n.off().on("click", function() {
                    return e.trigger("prev.owl"),
                    !1
                }),
                a.off().on("click", function() {
                    return e.trigger("next.owl"),
                    !1
                })
            }),
            e.imgToSVG(),
        ...
        cursor: function() {
            if (o(".frenify-cursor").length) {
                ...
                o("body").on("mouseleave", e, function() {
                    o(this).is("a") && o(this).closest(".cursor-link").length || (n.classList.remove("cursor-hover"),
                ...
                o("body").on("mousedown", t, function() {
                    n.classList.add("mouse-down"),
                    a.classList.add("mouse-down")
        ...
        tabs: function() {
            o(".resumo_fn_tabs .tab_header a").off().on("click", function() {
                ...
                return !n.hasClass("active") && (n.siblings().removeClass("active"),
